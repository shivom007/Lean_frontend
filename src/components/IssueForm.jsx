...
const IssueForm = ({setMessage, setIsSubmitted, handleClose}) => {
  ...
  const handleSubmit = (event) => {
    ...
    setMessage("Thanks for bringing the issue to our attention. We'll review it shortly and provide an update soon!")
    setIsSubmitted(true)
    handleClose()
  };
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <div style={{ display: "flex", justifyContent: "space-between", height:'40px', alignItems:'center' }}>
                <button
                  onClick={handleInput}
                  type="button"
                  style={{
